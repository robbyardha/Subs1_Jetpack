...
class MainActivityCompleteTest
{
    ...
    fun loadDetailMovie(){
        ...
        onView(withId(R.id.tv_duration)).check(matches(withText(Mov[0].duration)))
        onView(withId(R.id.tv_year)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_year)).check(matches(withText(Mov[0].yearrelease)))
        onView(withId(R.id.tv_score)).check(matches(isDisplayed()))
        onView(withId(R.id.tv_score)).check(matches(withText(Mov[0].score)))
...
//        onView(withId(R.id.tv_genre)).check(matches(isDisplayed()))
//        onView(withId(R.id.tv_genre)).check(matches(withText(dummyTvMovie[0].genre)))
//        onView(withId(R.id.tv_overview)).check(matches(isDisplayed()))
//        onView(withId(R.id.tv_overview)).check(matches(withText(dummyTvMovie[0].overview)))
//        onView(withId(R.id.tv_release)).check(matches(isDisplayed()))
//        onView(withId(R.id.tv_release)).check(matches(withText(dummyTvMovie[0].release)))
//    }
    }
}